...
Widget headerContent({isBackButton = false, titleName, fontSize, colorConstants, required Function(bool) callBack }) {
  return Container(
    child: isBackButton
        ? GestureDetector(
      onTap: ()=>callBack(true),
          child: Row(
              children: [
                Padding(
                  padding: EdgeInsets.only(left: 4.w, right: 22.w),
                  child: Icon(
...
Widget centerContent({titleName, description, fontSize, colorConstants, descriptionColor}) {
  return Column(
